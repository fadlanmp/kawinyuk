    ...
    <body>
        <div class="logregis-grid">
            ...
            <div class="logregis-form">
                ...
                <div class="logregis-row">
                    <form action="#routelogin" method="POST">
                        <div class="input-icons">
                            <i class="fa fa-user icon"></i>
                            <input class="logregis-input" type="text" name="#" id="#" placeholder="Username">
                        </div>
                        <div class="input-icons">
                            <i class="fa fa-lock icon"></i>
                            <input class="logregis-input" type="password" name="#" id="#" placeholder="Password">
                        </div>
                        <div class="login">
