...
<html>
    ...
    <body>
        ...
        <div class="vendors-container2">
            <h4 style="margin-top: 30px; margin-bottom: 30px;"><a href="#landingpage" style="color: #583178; text-decoration: none;">Home/</a>Videografer/Fotografi</h4>
            <div class="vendors-grid2">
